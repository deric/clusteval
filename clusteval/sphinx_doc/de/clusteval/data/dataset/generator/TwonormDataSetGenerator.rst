...
.. java:type:: @RLibraryRequirement public class TwonormDataSetGenerator extends DataSetGenerator
...
.. java:field:: protected int numberDimensions
   :outertype: TwonormDataSetGenerator
...
.. java:constructor:: public TwonormDataSetGenerator(Repository repository, boolean register, long changeDate, File absPath) throws RegisterException
   :outertype: TwonormDataSetGenerator
...
.. java:constructor:: public TwonormDataSetGenerator(DataSetGenerator other) throws RegisterException
   :outertype: TwonormDataSetGenerator
