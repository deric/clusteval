...
RunResultDataSetConfigParser
============================

.. java:package:: de.clusteval.framework.repository.parse
   :noindex:

.. java:type::  class RunResultDataSetConfigParser extends DataSetConfigParser
...
.. java:method:: @Override protected DataSet getDataSet()
   :outertype: RunResultDataSetConfigParser
